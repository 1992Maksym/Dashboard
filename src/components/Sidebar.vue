  ...
  <div class="sidebar">
    <div class="container">
      <div class="main">
        <div class="header">
          <router-link to="/">
            <img class="header-icon" src="../assets/icons/main-icon.png" alt="main-icon">
            <div class="header-main__text">
              <span class="header-title">Dashboard</span>
              <span class="header-version">v.01</span>
            </div>
          </router-link>
        </div>
        <ul class="menu">
          ...
          <li class="menu-item"  :class="{active : $route.path.indexOf('/product') !== -1}">
            <router-link to="/product">
              <div class="menu-item__wrap">
                ...
                <a href="#">
                  <div class="menu-item__text">Product</div>
                </a>
              </div>
          ...
          <li class="menu-item" :class="{active : $route.path.indexOf('/customers') !== -1}">
            <router-link to="/customers">
              <div class="menu-item__wrap">
                ...
                <a href="#">
                  <div class="menu-item__text">Customers</div>
                </a>
              </div>
              <div class="menu-item__arrow">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="menu-item" :class="{active : $route.path.indexOf('/income') !== -1}">
            <router-link to="/income">
              <div class="menu-item__wrap">
                ...
                <a href="#">
                  <div class="menu-item__text">Income</div>
                </a>
              </div>
              <div class="menu-item__arrow">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="menu-item" :class="{active : $route.path.indexOf('/promote') !== -1}">
            <router-link to="/promote">
              <div class="menu-item__wrap">
                ...
                <a href="#">
                  <div class="menu-item__text">Promote</div>
                </a>
              </div>
              <div class="menu-item__arrow">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
